def operators():
    ...
    list_of_mod=[]
    list_of_reminder=[]
    return list_of_add, list_of_sub, list_of_mul, list_of_div, list_of_mod, list_of_reminder  # return the list 

def add(num_1,num_2):
    list_of_add,list_of_sub, list_of_mul, list_of_div, list_of_mod, list_of_reminder =operators() 
    add=num_1+num_2
